...
set(MKL_LIBRARIES ${MKL_CORE_LIB} ${MKL_LP64_LIB} ${MKL_SEQUENTIAL_LIB} CACHE INTERNAL "Intel MKL Libraries" PARENT_SCOPE)
set(MKL_INCLUDE_DIR ${MKL_ROOT_DIR}/include CACHE INTERNAL "MKL Include Directory" PARENT_SCOPE)
...
set(DAAL_LIBRARIES ${DBB_LIB} ${DBB_MALLOC_LIB} ${DAAL_CORE_LIB} CACHE INTERNAL "Intel DAAL Libraries" PARENT_SCOPE) 
set(DAAL_INCLUDE_DIR ${DAAL_ROOT_DIR}/include CACHE INTERNAL "DAAL Include Directory" PARENT_SCOPE)
