...
namespace inpainting
{
	...
	void Log::setSourcePosition(libmmv::Vec3i position)
	{
		this->sourcePosition = position;
	}

	void Log::setTargetPosition(libmmv::Vec3i position)
	{
	...
	void Log::setBestBruteForcePosition(libmmv::Vec3i position)
	{
