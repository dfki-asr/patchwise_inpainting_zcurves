...
namespace inpainting
{
		...
		, zeroDistanceRange(0)
    {
        ...
        volumeStatistics = libmmv::VolumeStatistics::compute(dictionaryVolume);
	...
	libmmv::Vec3i CurveBasedPatchSelection::adjustTargetPatchPosition(libmmv::Vec3i targetPatchCenter)
	{
		if ( index == nullptr )
	...
	libmmv::Vec3i CurveBasedPatchSelection::selectCenterOfBestPatch(libmmv::Vec3i centerOfTargetPatch )
    {
	...
	libmmv::Vec3i CurveBasedPatchSelection::ensureTargetPatchPositionInsideSafeRegion(libmmv::Vec3i targetPatchCenter)
	{
	...
	libmmv::Vec3ui CurveBasedPatchSelection::findMinimumInResult()
    {
        ...
        const libmmv::Vec3ui bestCoordinate = Unflatten3D( dictionaryPatches[bestIndexInResultVector], dictionaryVolume->getProperties().getVolumeResolution() );
	...
	void CurveBasedPatchSelection::setCenterOfTargetPatch(libmmv::Vec3i centerOfTargetPatch )
	{
