...
namespace inpainting {
	...
	MaskedDictionaryBuilder::MaskedDictionaryBuilder( libmmv::ByteVolume* dictionaryVolume, libmmv::Vec3ui patchSize)
    ...
    std::vector<libmmv::Vec3ui> MaskedDictionaryBuilder::extractValidPatchPositions()
    {
        libmmv::Vec3ui patchCenterCoord;
        libmmv::Vec3ui volumeRes = libmmv::Vec3ui(0, 0, 0);
        size_t voxelCount = 0;
	...
	bool MaskedDictionaryBuilder::isPatchPositionValid(libmmv::Vec3ui patchCenterCoord)
	{
