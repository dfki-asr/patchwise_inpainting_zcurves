...
namespace ettention
{
    namespace inpainting
    {
		...
		IDistanceIndex::IDistanceIndex( ByteVolume* data, ByteVolume* mask, ByteVolume* dictionary, std::vector<unsigned int>& patchIds, Vec3ui patchSize, DimensionSelection::PreferredDirection preferredDirection, int unprojectedSize, int subspaceDimensions, int filterSize )
		...
		std::tuple<ettention::Vec3i, float> IDistanceIndex::query( Vec3i targetPatchCenter )
		{
