...
namespace inpainting
{
	...
	SubspaceProjection SubspaceProjection::empty()
	{
		return SubspaceProjection( 0, 0 );
	}

	SubspaceProjection SubspaceProjection::identity( int size )
	{
	...
	SubspaceProjection SubspaceProjection::random(int unprojectedSize, int projectedSize)
	{
